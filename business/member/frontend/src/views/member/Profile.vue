<template>
  <div class="profile-page" v-loading="loading">
    <el-card>
      ...
      <el-form ref="formRef" :model="form" :rules="rules" label-width="130px" size="large">
        <el-row :gutter="20">
          <el-col :span="8">
          ...
          <el-col :span="8">
            <template v-if="form.member_type === 'unit'">
              ...
              <el-form-item label="成立日期"><el-date-picker v-model="form.founded_date" type="date" value-format="YYYY-MM-DD" style="width:100%" /></el-form-item>
              <el-form-item label="注册资本"><el-input v-model="form.registered_capital" placeholder="单位：万元" /></el-form-item>
              <el-form-item label="员工规模"><el-input-number v-model="form.employee_count" :min="0" style="width:100%" /></el-form-item>
            </template>
            <template v-else>
          ...
          <el-col :span="8">
            <template v-if="form.member_type === 'unit'">
              ...
              <el-form-item label="联系人职务"><el-input v-model="form.contact_title" /></el-form-item>
              <el-form-item label="联系人手机号"><el-input v-model="form.contact_mobile" maxlength="11" /></el-form-item>
              ...
              <el-form-item label="经营范围"><el-input v-model="form.business_scope" type="textarea" :rows="3" /></el-form-item>
              <el-form-item label="邮编"><el-input v-model="form.postal_code" maxlength="6" /></el-form-item>
