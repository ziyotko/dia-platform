  ...
  <div class="admin-anns" v-loading="loading">
    ...
    <el-card>
      <el-table :data="list" stripe>
        ...
        <el-table-column prop="is_pinned" label="置顶" width="70"><template #default="{row}"><el-tag size="small" :type="row.is_pinned?'danger':'info'">{{ row.is_pinned?'是':'否' }}</el-tag></template></el-table-column>
