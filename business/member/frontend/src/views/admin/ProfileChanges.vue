<template>
  <div class="admin-profile-changes" v-loading="loading">
    ...
    <el-card>
      <el-table :data="list" stripe style="width: 100%" class="profile-changes-table" :row-class-name="tableRowClassName" @row-click="openDetail">
...
.profile-changes-table :deep(.profile-changes-row) {
  cursor: pointer;
}
.profile-changes-table :deep(.profile-changes-row:hover td) {
