...
declare const __VLS_base: _$vue.DefineComponent<_$vue.ExtractPropTypes<{
  ...
  readonly modelValue: EpPropFinalized<(new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType | null) | (((new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType | null)) | null)[], unknown, unknown, "", boolean>;
  ...
  readonly modelValue: EpPropMergeType<(new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType | null) | (((new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType | null)) | null)[], unknown, unknown>;
