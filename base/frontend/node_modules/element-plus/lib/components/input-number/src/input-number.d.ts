...
declare const inputNumberProps: {
  ...
  readonly valueOnClear: EpPropFinalized<(new (...args: any[]) => number | "min" | "max") | (() => number | "min" | "max" | null) | (((new (...args: any[]) => number | "min" | "max") | (() => number | "min" | "max" | null)) | null)[], unknown, unknown, null, boolean>;
