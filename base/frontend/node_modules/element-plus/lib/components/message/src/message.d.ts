...
declare const messageProps: {
  ...
  readonly icon: EpPropFinalized<(new (...args: any[]) => (string | _$vue.Component) & {}) | (() => string | _$vue.Component) | (((new (...args: any[]) => (string | _$vue.Component) & {}) | (() => string | _$vue.Component)) | null)[], unknown, unknown, undefined, boolean>;
  ...
  readonly type: EpPropFinalized<StringConstructor, "error" | "primary" | "success" | "info" | "warning", unknown, "info", boolean>;
