...
//#region ../../packages/locale/lang/no.ts
var no_default = {
	name: "no",
	el: {
		breadcrumb: { label: "Brødsmuler" },
		colorpicker: {
			confirm: "Bekreft",
			clear: "Tøm",
			...
			svDescription: "metning {saturation}, lysstyrke {brightness}, nåværende farge er {color}",
		...
		dropdown: { toggleDropdown: "Vis/skjul nedtrekksmeny" },
		cascader: {
			noMatch: "Ingen treff",
			loading: "Laster",
			placeholder: "Velg",
		...
		dialog: { close: "Lukk denne dialogboksen" },
		drawer: { close: "Lukk denne dialogboksen" },
		messagebox: {
			title: "Varsel",
			confirm: "Bekreft",
			cancel: "Avbryt",
