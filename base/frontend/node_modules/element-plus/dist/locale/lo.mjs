...
//#region ../../packages/locale/lang/lo.ts
var lo_default = {
	name: "lo",
	el: {
		breadcrumb: { label: "ເມນູນຳທາງ" },
		colorpicker: {
			confirm: "ຕົກລົງ",
			clear: "ລ້າງ",
		...
		mention: { loading: "ກຳລັງໂຫຼດ" },
		dropdown: { toggleDropdown: "ສະຫຼັບເມນູ" },
		cascader: {
			noMatch: "ບໍ່ພົບຂໍ້ມູນທີ່ກົງກັນ",
			loading: "ກຳລັງໂຫຼດ",
			placeholder: "ເລືອກ",
		...
		dialog: { close: "ປິດກ່ອງຂໍ້ຄວາມນີ້" },
		drawer: { close: "ປິດກ່ອງຂໍ້ຄວາມນີ້" },
		messagebox: {
			title: "ຂໍ້ຄວາມ",
			confirm: "ຕົກລົງ",
			cancel: "ຍົກເລີກ",
		...
		image: { error: "ເກີດຂໍ້ຜິດພາດ" },
		pageHeader: { title: "ກັບຄືນ" },
		popconfirm: {
