...
//#region ../../packages/locale/lang/sw.ts
var sw_default = {
	name: "sw",
	el: {
		...
		mention: { loading: "inapakia" },
		dropdown: { toggleDropdown: "geuza kunyuzi" },
		cascader: {
			noMatch: "hakuna data inayolingana",
			loading: "pakia",
			placeholder: "chagua",
		...
		dialog: { close: "funga kidirisha hiki" },
		drawer: { close: "funga kidirisha hiki" },
		messagebox: {
			title: "ujumbe",
			confirm: "sawa",
			cancel: "futa",
		...
		image: { error: "imeshindwa" },
		pageHeader: { title: "nyuma" },
		popconfirm: {
