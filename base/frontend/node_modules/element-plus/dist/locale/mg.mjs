...
//#region ../../packages/locale/lang/mg.ts
var mg_default = {
	name: "mg",
	el: {
		...
		mention: { loading: "Eo ampiandrasana" },
		...
		tree: { emptyText: "Tsy misy angona" },
		transfer: {
			noMatch: "Tsy misy angona mifanentana",
			noData: "Tsy misy angona",
		...
		image: { error: "TSY NAHOMBY" },
		pageHeader: { title: "Miverina" },
		popconfirm: {
