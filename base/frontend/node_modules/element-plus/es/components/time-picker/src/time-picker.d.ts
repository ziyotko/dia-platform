...
declare const _default: _$vue.DefineComponent<_$vue.ExtractPropTypes<{
  ...
  modelValue: EpPropFinalized<(new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType | null) | (((new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType | null)) | null)[], unknown, unknown, "", boolean>;
  ...
  type: string;
  modelValue: EpPropMergeType<(new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType | null) | (((new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType | null)) | null)[], unknown, unknown>;
  placeholder: string;
