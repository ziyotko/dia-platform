...
declare const _default: _$vue.DefineComponent<_$vue.ExtractPropTypes<{
  ...
  readonly modelValue: EpPropFinalized<(new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType) | (((new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType)) | null)[], unknown, unknown, "", boolean>;
...
}>, () => _$vue_jsx_runtime0.JSX.Element, {}, {}, {}, _$vue.ComponentOptionsMixin, _$vue.ComponentOptionsMixin, ("clear" | "update:modelValue" | "calendar-change" | "panel-change" | "visible-change")[], "clear" | "update:modelValue" | "calendar-change" | "panel-change" | "visible-change", _$vue.PublicProps, Readonly<_$vue.ExtractPropTypes<{
  readonly disabledDate: {
    readonly type: _$vue.PropType<Function>;
    readonly required: false;
    readonly validator: ((val: unknown) => boolean) | undefined;
  ...
  readonly modelValue: EpPropMergeType<(new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType) | (((new (...args: any[]) => string | number | string[] | Date | Date[] | number[]) | (() => ModelValueType)) | null)[], unknown, unknown>;
